                ...
                {{ csrf_field() }}
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control" id="name" placeholder="Naam" name="name" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" placeholder="E-pos" name="email" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Boodskap" name="message" rows="6" required></textarea>
                        </div>
                    </div>
