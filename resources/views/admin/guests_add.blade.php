            ...
            <form role="form" action="" method="post">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <button type="submit" class="btn btn-primary btn-block">+ Add Guest<div class="ripple-container"></div></button>
                    </div>
                </div>
                <hr>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <p>Note: This guest will be added to your <strong>Provisional Guests</strong> list. When you are ready, you can click on the <strong>Email Invite</strong> button to send them an official invite.</p>
                    </div>
                </div>
            </form>
        </div>
